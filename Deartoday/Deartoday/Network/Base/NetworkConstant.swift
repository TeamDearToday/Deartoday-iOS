...
struct NetworkConstant {
    ...
    static let hasTokenHeader = ["Content-Type": "application/json",
                                 "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjJkNTAyMWEyNDEzM2E4OTU3M2YzODM3In0sImlhdCI6MTY1ODE2ODk3MiwiZXhwIjoxNjU4MTcyNTcyfQ.5QCfeLjSWv-WPmJpXTKnUCak0rI4HSmGMwPhytt-uYc"]
